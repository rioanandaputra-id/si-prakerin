...
$routes->group('admin', ['namespace' => 'App\Controllers\admin', 'filter' => 'role:Admin'], function ($routes) {
    ...
    $routes->get('datamaster/dokuman', 'DataMaster::view_dokumen');
    ...
    $routes->get('datamaster/dokuman/add', 'DataMaster::view_add_dokumen');
    ...
    $routes->get('datamaster/dokuman/edit', 'DataMaster::view_edit_dokumen');
    ...
    $routes->post('datamaster/dokuman/create', 'DataMaster::create_dokumen');
    ...
    $routes->put('datamaster/dokuman/update', 'DataMaster::update_dokumen');
    ...
    $routes->delete('datamaster/dokuman/delete', 'DataMaster::delete_dokumen');
});
