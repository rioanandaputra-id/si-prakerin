...
<?php echo $title = 'Data Master - Ubah Tahun Akademik'; ?>
<?php $this->endSection(); ?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?= msgg(); ?>
                ...
                <div class="card">
                    <form action="<?= site_url('admin/datamaster/tahunakademik/update') ?>" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <input type="hidden" value="<?= $_GET['id']; ?>" name="id_tahun_akademik"/>
                                <label for="tahun_akademik">Tahun Akademik: <i class="text-danger">*</i></label>
                                <input type="text" class="form-control <?php if (session('errors.tahun_akademik')) : ?>is-invalid<?php endif ?>" name="tahun_akademik" placeholder="Masukan Tahun Akademik" value="<?= $tahun_akademik['tahun_akademik']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?php if (session('errors.status_tahun_akademik')) : ?>is-invalid<?php endif ?>" id="status_tahun_akademik" name="status_tahun_akademik">
                                    ...
                                    <option value="Aktif" <?= ($tahun_akademik['status_tahun_akademik'] == 'Aktif') ? 'selected' : ''; ?> >Aktif</option>
                                    <option value="Tidak Aktif" <?= ($tahun_akademik['status_tahun_akademik'] == 'Tidak Aktif') ? 'selected' : ''; ?>>Tidak Aktif</option>
                                </select>
                                <small class="text-danger">
