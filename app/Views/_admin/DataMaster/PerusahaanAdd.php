...
<?php echo $title = 'Data Master - Tambah Perusahaan'; ?>
<?php $this->endSection(); ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form action="<?= site_url('admin/datamaster/perusahaan/create') ?>" method="POST">
                        <div class="card-body">
                            ...
                            <label for="status_perusahaan">Status Perusahaan<i class="text-danger">*</i></label>
                                        <select name="status_perusahaan" class="form-control <?php if (session('errors.status_perusahaan')) : ?>is-invalid<?php endif ?>">
                                            <option value="">--Pilih Status--</option>
                                                <option value="Aktif" <?= (old('status_perusahaan') == 'Aktif') ? 'selected' : ''; ?>>Aktif</option>
                                                <option value="Tidak Aktif" <?= (old('status_perusahaan') == 'Tidak Aktif') ? 'selected' : ''; ?>>Tidak Aktif</option>
                                        </select>
